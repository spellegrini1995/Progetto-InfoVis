var dataset = [
    ...
    selected_filter = setAreaAndCategory('Italian','Pasta')
    Edge_Graph = selected_filter[2];
    selected_meals = selected_filter[0];
    ingredients = selected_filter[1];
